function [freq, t, y] = simulate_metabolator_mod(opt)
    ...
    default_params = struct('k1', 80,...
                            ...
                            'kd', 0.06,...
                            'n', 2,...
                            'beta_max', 40,... % maximum blocking parameter value
                            'B', 0,... % amount of blocker present
                            'B_half', 8,... % amount of B at which half of beta_max is reached
                            'tspan', [0 2000],...
                            'y0', zeros(1,7));
    ...
    [t, y] = ode45(@ODE_metabolator_mod, params.tspan, params.y0, [], ...
        ...
        params.kd, params.n, params.beta_max, params.B, params.B_half);
